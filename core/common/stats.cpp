...
bool Stats::writeVariable(Stream &out, const String &var) {
    ...
    if (var == "totalInPerSec")
        ...
        sprintf(buf, "%.1f", (double) getPerSecond(Stats::NUMPACKETSIN));
    else if (var == "packOutPerSec")
        sprintf(buf, "%.1f", (double) getPerSecond(Stats::NUMPACKETSOUT));
    else if (var == "packTotalPerSec")
        sprintf(buf, "%.1f", (double) getPerSecond(Stats::NUMPACKETSOUT) + getPerSecond(Stats::NUMPACKETSIN));
