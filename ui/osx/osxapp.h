...
public:
    ...
    virtual void APICALL
    notifyMessage(ServMgr::NOTIFY_TYPE,
    const char *);
    virtual void APICALL
...
private:
    ...
    public:
        ...
        int localListeners() const {
            return mLocalListeners;
        }

        int localRelays() const {
            return mLocalRelays;
        }
    ...
    public:
        ...
        bool operator()(TChanStatusPtr &chanStatus) {
            return chanStatus->getId().isSame(mSearchId);
        }
